(custom-set-variables
 ...
 '(package-selected-packages
   '(avy carbonnow company consult copilot doom-themes gotest gptel kanagawa-themes
		 magit marginalia markdown-mode orderless paredit projectile rg
		 standard-themes vertico xid yasnippet-snippets))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 140 :width normal :foundry "nil" :family "Inconsolata")))))
