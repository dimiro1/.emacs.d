;;; cafn-environment.el --- System paths and environment configuration  -*- lexical-binding: t; -*-
...
;;; PATH Configuration
;; Add common development tool locations to Emacs' execution path
(use-package emacs
  :init
...
;; Handle macOS-specific environment needs
(use-package emacs
  :init
...
;; Configure authentication sources for macOS
(use-package emacs
  :custom
...
(provide 'cafn-environment)
;;; cafn-environment.el ends here